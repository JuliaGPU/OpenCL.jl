...
@ocl_func(clGetPlatformInfo,
              CL_int, (CL_platform_id, CL_platform_info, Csize_t, Ptr{Cvoid}, Ptr{Csize_t}))
...
@ocl_func(clGetDeviceInfo, CL_int,
              (CL_device_id, CL_device_info, Csize_t, Ptr{Cvoid}, Ptr{Csize_t}))
...
@ocl_func(clGetContextInfo, CL_int,
              (CL_context, CL_context_info, Csize_t, Ptr{Cvoid}, Ptr{Csize_t}))
...
@ocl_func(clGetCommandQueueInfo, CL_int,
              (CL_command_queue, CL_command_queue_info, Csize_t, Ptr{Cvoid}, Ptr{Csize_t}))

#=== memory object apis ===#
@ocl_func(clCreateBuffer, CL_mem,
              (CL_context, CL_mem_flags, Csize_t, Ptr{Cvoid}, Ptr{CL_int}))
...
@ocl_func(clGetMemObjectInfo, CL_mem,
              (CL_mem, CL_mem_info, Csize_t, Ptr{Cvoid}, Ptr{Csize_t}))

@ocl_func(clGetImageInfo, CL_mem,
              (CL_mem, CL_image_info, Csize_t, Ptr{Cvoid}, Ptr{Csize_t}))
...
@ocl_func(clGetSamplerInfo, CL_int,
              (CL_sampler, CL_sampler_info, Csize_t, Ptr{Cvoid}, Ptr{Csize_t}))
...
@ocl_func(clBuildProgram, CL_int,
              (CL_program, CL_uint, Ptr{CL_device_id}, Ptr{Cchar}, CL_callback, Ptr{Cvoid}))

@ocl_func(clGetProgramBuildInfo, CL_int,
              (CL_program, CL_device_id, CL_program_build_info, Csize_t, Ptr{Cvoid}, Ptr{Csize_t}))
...
@ocl_func(clSetKernelArg, CL_int,
              (CL_kernel, CL_uint, Csize_t, Ptr{Cvoid}))

@ocl_func(clGetKernelInfo, CL_int,
              (CL_kernel, CL_kernel_info, Csize_t, Ptr{Cvoid}, Ptr{Csize_t}))

@ocl_func(clGetKernelWorkGroupInfo, CL_int,
              (CL_kernel, CL_device_id, CL_kernel_work_group_info, Csize_t, Ptr{Cvoid}, Ptr{Csize_t}))
...
@ocl_func(clGetEventInfo, CL_int,
              (CL_event, CL_event_info, Csize_t, Ptr{Cvoid}, Ptr{Csize_t}))
...
@ocl_func(clGetEventProfilingInfo, CL_int,
              (CL_event, CL_profiling_info, Csize_t, Ptr{Cvoid}, Ptr{Csize_t}))
...
@ocl_func(clEnqueueWriteImage, CL_int,
              (CL_command_queue, CL_mem, CL_bool, Ptr{Csize_t}, Ptr{Csize_t},
               Csize_t, Csize_t, Ptr{Cvoid}, CL_uint, Ptr{CL_event}, Ptr{CL_event}))
...
@ocl_func(clEnqueueUnmapMemObject, CL_int,
              (CL_command_queue, CL_mem, Ptr{Cvoid}, CL_uint, Ptr{CL_event}, Ptr{CL_event}))
...
@ocl_func(clEnqueueNativeKernel, CL_int,
              (CL_command_queue, Ptr{Cvoid}, Csize_t, CL_uint,
               Ptr{CL_mem}, Ptr{Ptr{Cvoid}}, CL_uint, Ptr{CL_event}, Ptr{CL_event}))
...
@ocl_func(clGetGLTextureInfo, CL_int,
              (CL_mem, CL_GL_texture_info, Csize_t, Ptr{Cvoid}, Ptr{Csize_t}))
