...
@ocl_func(clCreateImage, CL_mem,
              (CL_context, CL_mem_flags, CL_image_format, CL_image_desc, Ptr{Cvoid}, Ptr{CL_int}))
...
@ocl_func(clGetExtensionFunctionAddressForPlatform, Ptr{Cvoid},
...
# @deprecate clUnloadCompiler Cvoid()
