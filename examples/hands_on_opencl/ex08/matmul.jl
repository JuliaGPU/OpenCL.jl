...
if Ndim * (ORDER ÷ 16) >= wk_size
    ...
    for i in 1:COUNT
        ...
        cl.queue!(:profile) do
            ...
            evt = clcall(
                mmul, Tuple{Int32, Int32, Int32, Ptr{Float32}, Ptr{Float32}, Ptr{Float32}, cl.LocalMem{Float32}},
...
if Ndim * (ORDER ÷ 16) >= wk_size
    ...
    for i in 1:COUNT
        ...
        cl.queue!(:profile) do
            evt = clcall(
                mmul, Tuple{Int32, Int32, Int32, Ptr{Float32}, Ptr{Float32}, Ptr{Float32}, Ptr{Float32}, Ptr{Float32}},
